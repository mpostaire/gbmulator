...
ODIR=build
IDIR=$(SDIR)
CFLAGS=-std=gnu23 -Wall -Wextra -fanalyzer -Wno-unused-parameter -Wno-missing-field-initializers -Wno-cast-function-type -O3 -I$(IDIR) -DVERSION=$(shell git rev-parse --short HEAD)
LDLIBS=
CC=gcc
BIN=gbmulator
