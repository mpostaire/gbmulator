...
static void exec_extended_opcode(emulator_t *emu) {
    ...
    case 0x06: // RLC (HL) (12 cycles)
        CLOCK(
            ...
            rlc(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
    ...
    case 0x0E: // RRC (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            rrc(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x16: // RL (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            rl(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x1E: // RR (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            rr(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x26: // SLA (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            sla(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x2E: // SRA (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            sra(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x36: // SWAP (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            swap(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x3E: // SRL (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            srl(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x86: // RES 0, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 0);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x8E: // RES 1, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 1);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x96: // RES 2, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 2);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x9E: // RES 3, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 3);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xA6: // RES 4, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 4);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xAE: // RES 5, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 5);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xB6: // RES 6, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 6);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xBE: // RES 7, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            RESET_BIT(cpu->opcode_compute_storage, 7);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xC6: // SET 0, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            SET_BIT(cpu->opcode_compute_storage, 0);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xCE: // SET 1, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            SET_BIT(cpu->opcode_compute_storage, 1);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xD6: // SET 2, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            SET_BIT(cpu->opcode_compute_storage, 2);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xDE: // SET 3, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            SET_BIT(cpu->opcode_compute_storage, 3);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xE6: // SET 4, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            SET_BIT(cpu->opcode_compute_storage, 4);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xEE: // SET 5, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            SET_BIT(cpu->opcode_compute_storage, 5);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0xF6: // SET 6, (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            SET_BIT(cpu->opcode_compute_storage, 6);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
...
static void exec_opcode(emulator_t *emu) {
    ...
    case 0x0A: // LD A,(BC) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.bc));
    ...
    case 0x13: // INC DE (8 cycles)
        CLOCK(cpu->opcode_compute_storage = cpu->registers.de);
        CLOCK(cpu->registers.de = cpu->opcode_compute_storage + 1; END_OPCODE;);
    ...
    case 0x1A: // LD A,(DE) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.de));
        CLOCK(cpu->registers.a = cpu->opcode_compute_storage; END_OPCODE;);
    ...
    case 0x2A: // LDI A, (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(
            cpu->registers.a = cpu->opcode_compute_storage;
            cpu->registers.hl++;
            END_OPCODE;
        );
    ...
    case 0x34: // INC (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            inc(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    case 0x35: // DEC (HL) (12 cycles)
        CLOCK(
            cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl);
            dec(cpu, (byte_t *) &cpu->opcode_compute_storage);
        );
        CLOCK(mmu_write(emu, cpu->registers.hl, cpu->opcode_compute_storage));
        CLOCK(END_OPCODE);
    ...
    case 0x46: // LD B,(HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(cpu->registers.b = cpu->opcode_compute_storage; END_OPCODE);
    ...
    case 0x4E: // LD C,(HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(cpu->registers.c = cpu->opcode_compute_storage; END_OPCODE;);
    ...
    case 0x56: // LD D,(HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(cpu->registers.d = cpu->opcode_compute_storage; END_OPCODE;);
    ...
    case 0x5E: // LD E,(HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(cpu->registers.e = cpu->opcode_compute_storage; END_OPCODE;);
    ...
    case 0x66: // LD H,(HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(cpu->registers.h = cpu->opcode_compute_storage; END_OPCODE;);
    ...
    case 0x86: // ADD A, (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(add8(cpu, cpu->opcode_compute_storage); END_OPCODE;);
    ...
    case 0x8E: // ADC A, (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(adc(cpu, cpu->opcode_compute_storage); END_OPCODE;);
    ...
    case 0x96: // SUB A, (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(sub8(cpu, cpu->opcode_compute_storage); END_OPCODE);
    ...
    case 0x9E: // SBC A, (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(sbc(cpu, cpu->opcode_compute_storage); END_OPCODE;);
    ...
    case 0xA6: // AND (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(and(cpu, cpu->opcode_compute_storage); END_OPCODE;);
    ...
    case 0xAE: // XOR (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(xor(cpu, cpu->opcode_compute_storage); END_OPCODE;);
    ...
    case 0xB6: // OR (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(or(cpu, cpu->opcode_compute_storage); END_OPCODE;);
    ...
    case 0xBE: // CP (HL) (8 cycles)
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, cpu->registers.hl));
        CLOCK(cp(cpu, cpu->opcode_compute_storage); END_OPCODE;);
    ...
    case 0xE8: // ADD SP, n (16 cycles)
        GET_OPERAND_8();
        CLOCK(cpu->opcode_compute_storage = cpu->registers.sp + (s_byte_t) cpu->operand);
        CLOCK(
        ...
        CLOCK(
            cpu->registers.sp = cpu->opcode_compute_storage & 0xFFFF;
    ...
    case 0xF0: // LD A, (0xFF00 + n) (12 cycles)
        GET_OPERAND_8();
        CLOCK(cpu->opcode_compute_storage = mmu_read(emu, IO + cpu->operand));
        CLOCK(cpu->registers.a = cpu->opcode_compute_storage; END_OPCODE;);
    ...
    case 0xF8: // LD HL, SP+n (12 cycles)
        GET_OPERAND_8();
        CLOCK(
            cpu->opcode_compute_storage = cpu->registers.sp + (s_byte_t) cpu->operand;
            (((cpu->registers.sp & 0xFF) + ((s_byte_t) cpu->operand & 0xFF)) & 0x100) == 0x100 ? SET_FLAG(cpu, FLAG_C) : RESET_FLAG(cpu, FLAG_C);
            (((cpu->registers.sp & 0x0F) + ((s_byte_t) cpu->operand & 0x0F)) & 0x10) == 0x10 ? SET_FLAG(cpu, FLAG_H) : RESET_FLAG(cpu, FLAG_H);
        );
        CLOCK(
            cpu->registers.hl = cpu->opcode_compute_storage & 0xFFFF;
            RESET_FLAG(cpu, FLAG_N | FLAG_Z);
            END_OPCODE;
        );
